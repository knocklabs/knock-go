...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Users.Get(context.Background(), "user_id")
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Users.Get(context.Background(), "user_id")
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Users.Get(cancelCtx, "user_id")
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Users.Get(deadlineCtx, "user_id")
		if err == nil {
