...
<a href="https://pkg.go.dev/github.com/knocklabs/knock-go"><img src="https://pkg.go.dev/badge/github.com/knocklabs/knock-go.svg" alt="Go Reference"></a>

The Knock Go library provides convenient access to the [Knock REST API](https://docs.knock.app)
...
```sh
go get -u 'github.com/knocklabs/knock-go@v0.0.1-alpha.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/knocklabs/knock-go/option).
...
`*knock.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `knock.FileParam(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/knocklabs/knock-go/issues) with questions, bugs, or suggestions.
