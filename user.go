...
// [UserListMessagesResponseActorsObject].
...
func init() {
	apijson.RegisterUnion(
		...
		apijson.UnionVariant{
			TypeFilter: gjson.JSON,
			Type:       reflect.TypeOf(UserListMessagesResponseActorsObject{}),
		},
	)
}

// An object reference to a recipient
type UserListMessagesResponseActorsObject struct {
	// An object identifier
	ID string `json:"id,required"`
	// The collection the object belongs to
	Collection string                                   `json:"collection,required"`
	JSON       userListMessagesResponseActorsObjectJSON `json:"-"`
}

// userListMessagesResponseActorsObjectJSON contains the JSON metadata for the
// struct [UserListMessagesResponseActorsObject]
type userListMessagesResponseActorsObjectJSON struct {
	ID          apijson.Field
...
func (r *UserListMessagesResponseActorsObject) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r userListMessagesResponseActorsObjectJSON) RawJSON() string {
	return r.raw
}

func (r UserListMessagesResponseActorsObject) ImplementsUserListMessagesResponseActorsUnion() {}
...
//
// Union satisfied by [shared.UnionString] or
// [UserListMessagesResponseRecipientObject].
...
func init() {
	apijson.RegisterUnion(
		...
		apijson.UnionVariant{
			TypeFilter: gjson.JSON,
			Type:       reflect.TypeOf(UserListMessagesResponseRecipientObject{}),
		},
	)
}

// An object reference to a recipient
type UserListMessagesResponseRecipientObject struct {
	// An object identifier
	ID string `json:"id,required"`
	// The collection the object belongs to
	Collection string                                      `json:"collection,required"`
	JSON       userListMessagesResponseRecipientObjectJSON `json:"-"`
}

// userListMessagesResponseRecipientObjectJSON contains the JSON metadata for the
// struct [UserListMessagesResponseRecipientObject]
type userListMessagesResponseRecipientObjectJSON struct {
	ID          apijson.Field
	Collection  apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *UserListMessagesResponseRecipientObject) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r userListMessagesResponseRecipientObjectJSON) RawJSON() string {
	return r.raw
}

func (r UserListMessagesResponseRecipientObject) ImplementsUserListMessagesResponseRecipientUnion() {}
