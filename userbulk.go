...
func (r *UserBulkService) Delete(ctx context.Context, body UserBulkDeleteParams, opts ...option.RequestOption) (res *UserBulkDeleteResponse, err error) {
...
func (r *UserBulkService) Identify(ctx context.Context, opts ...option.RequestOption) (res *UserBulkIdentifyResponse, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *UserBulkService) SetPreferences(ctx context.Context, opts ...option.RequestOption) (res *UserBulkSetPreferencesResponse, err error) {
	opts = append(r.Options[:], opts...)
