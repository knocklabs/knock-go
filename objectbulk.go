...
func (r *ObjectBulkService) AddSubscriptions(ctx context.Context, collection string, opts ...option.RequestOption) (res *ObjectBulkAddSubscriptionsResponse, err error) {
	opts = append(r.Options[:], opts...)
	if collection == "" {
		err = errors.New("missing required collection parameter")
		return
...
func (r *ObjectBulkService) Set(ctx context.Context, collection string, opts ...option.RequestOption) (res *ObjectBulkSetResponse, err error) {
	opts = append(r.Options[:], opts...)
	if collection == "" {
		err = errors.New("missing required collection parameter")
		return
